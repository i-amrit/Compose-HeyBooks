...
<p> A simple android app written in Kotlin using Jetpack Compose to read books from the <a href="https://developers.google.com/books/docs/overview">Google Book Api</a>.<br></p>
